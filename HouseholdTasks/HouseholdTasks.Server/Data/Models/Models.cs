...
public class TaskAssignment
{
    ...
    /// <summary>Whether this person is "on duty" for this specific occurrence. True for everyone
    /// unless the task rotates (recurring + 2+ people), in which case exactly one is true.</summary>
