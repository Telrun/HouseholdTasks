...
public static class TaskEndpoints
{
    public static void MapTaskEndpoints(this WebApplication app)
    {
        ...
        group.MapPost("/", async (CreateHouseholdTaskDto dto, AppDbContext db, ClaimsPrincipal user) =>
        {
            ...
            var isRotating = dto.Recurrence != RecurrenceType.None && roster.Count > 1;
        ...
        group.MapPost("/{id:int}/complete", async (int id, AppDbContext db, ClaimsPrincipal user) =>
        {
            ...
            if (task.Recurrence != RecurrenceType.None)
            {
                ...
                var isRotating = task.Recurrence != RecurrenceType.None && rosterCount > 1;
                ...
                foreach (var assignment in task.Assignments)
                {
                    nextTask.Assignments.Add(new TaskAssignment
                    {
                        ...
                        IsActiveTurn = !isRotating || assignment.RosterOrder == nextTurnOrder
                    });
                }
    ...
    private static async Task<List<HouseholdTaskDto>> GetTasksForDate(AppDbContext db, DateOnly date)
    {
        ...
        return await db.Tasks
            ...
            .Select(t => new HouseholdTaskDto
            {
                ...
                IsRotating = t.Recurrence != RecurrenceType.None && t.Assignments.Count > 1,
